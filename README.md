...
| required     | Get and set the required state for contents                           |
| readOnly     | Get and set the readOnly state for the editor                         |
| disabled     | Get and set the disabled state for the editor                         |
| paragraphTag | Get and set the paragraph tag name                                    |
...
| getStyles           | Gets the active styles from the specified node                                |
| getCurrentStyles    | Get the styles map from the current focused node                              |
